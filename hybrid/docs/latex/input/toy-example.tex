...
\begin{figure}[ht!]
  ...
  \subfloat[The four layered structure of the toy example]{
    \includegraphics[width=.45\textwidth]{figs/toy-4layer}
    \label{fig:toy-4layer}}
  \hfill
  \subfloat[View from skeleton layer]{
    \includegraphics[width=0.5\textwidth]{figs/view_example_skeleton.pdf}
    \label{fig:subfig1}}%
  \hfill
  \subfloat[Top view from process layer]{
    \includegraphics[width=0.47\textwidth]{figs/view_example_unraveled.pdf}
    \label{fig:subfig2}}
  \hfill
  \subfloat[Flattened \& refined view from process layer]{
    \includegraphics[width=0.47\textwidth]{figs/view_example_flat.pdf}
    \label{fig:subfig3}}
  \hfill
  \subfloat[View from behavior layer, as projected by a timed MoC]{
    \includegraphics[width=0.47\textwidth]{figs/view_example_behavior.pdf}
    \label{fig:subfig4}}
  \hfill
  \subfloat[View from function layer, as projected by a timed MoC]{
    \includegraphics[width=0.47\textwidth]{figs/view_example_function.pdf}
    \label{fig:subfig5}}
