...
The reader is assumed to have been familiarized with the \textsc{ForSyDe-Atom} modeling framework. A good resource for that is \chapterref{ch:getting-started}. The main goals of this document are:
\begin{itemize}
