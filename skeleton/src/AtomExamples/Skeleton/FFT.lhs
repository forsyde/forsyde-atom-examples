...
-- > ampl1SY  vs = ( SY.comb11          magnitude  `V.farm11`) vs 
-- > ampl1DE  vs = ( DE.comb11          magnitude  `V.farm11`) vs 
-- > ampl1CT  vs = ( CT.comb11          magnitude  `V.farm11`) vs 
-- > ampl1SDF vs = (SDF.comb11 (1,1,map magnitude) `V.farm11`) vs

-- > ampl2SY  s  =   SY.comb11         (magnitude  `V.farm11`) s
-- > ampl2DE  s  =   DE.comb11         (magnitude  `V.farm11`) s
-- > ampl2CT  s  =   CT.comb11         (magnitude  `V.farm11`) s
